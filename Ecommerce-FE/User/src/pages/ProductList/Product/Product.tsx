...
function Product({ product, classNameBlock, rating }: ProductProps) {
  ...
  return (
    ...
    >
      <div>
        <img
          className='mx-auto h-[176px] w-full object-cover phone:h-[201px] md:h-[183px] lg:h-[162px] xl:h-[190px]'
          src={product.image}
          alt='img'
        />
      </div>
      <div className='p-2'>
        <p className='text-xs line-clamp-2 md:text-xs lg:text-xs xl:text-sm'>
          {product.name}
        </p>
