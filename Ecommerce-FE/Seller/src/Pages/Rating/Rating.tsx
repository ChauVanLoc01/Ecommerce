      ...
      <div className='bg-white space-y-2 rounded-xs'>
        <div className='flex items-end justify-between w-full border-b border-gray-200 py-2 px-3'>
          ...
          <div className='space-x-1 pr-3'>
            <span className='text-red-500 font-medium text-xl'>0.0</span>
            <span>/</span>
            <span>5</span>
          </div>
        </div>
        <div className='flex lg:flex-wrap gap-y-3 lg:pr-16 xl:pr-10'>
          <div className='flex space-x-2 items-center xl:basis-1/3 lg:basis-1/2 justify-end'>
            ...
            <div className='px-2 py-1.5 rounded-xs border border-gray-200'>
              <input className='outline-none w-full' placeholder='Nhập tên sản phẩm' type='text' name='' id='' />
            </div>
          </div>
          <div className='flex space-x-2 items-center xl:basis-1/3 lg:basis-1/2 justify-end'>
            <label htmlFor=''>Phân loại hàng</label>
            <div className='px-2 py-1.5 rounded-xs border border-gray-200'>
              <input className='outline-none w-full' placeholder='Nhập loại hàng' type='text' name='' id='' />
            </div>
          </div>
          <div className='flex space-x-2 items-center xl:basis-1/3 lg:basis-1/2 justify-end'>
            <label htmlFor=''>Người mua</label>
            <div className='px-2 py-2 rounded-xs border border-gray-200'>
              <input className='outline-none w-full' placeholder='Nhập tên người mua' type='text' name='' id='' />
            </div>
          </div>
          <div className='flex space-x-2 items-center xl:basis-1/3 lg:basis-1/2 justify-end'>
          ...
          <div className='lg:w-full xl:basis-1/3 xl:text-center lg:text-right space-x-5'>
            <button className='px-4 py-1 border text-white bg-primary hover:bg-primary/90 rounded-xs'>Tìm</button>
