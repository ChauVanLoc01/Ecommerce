...
const Header = forwardRef<HTMLDivElement>((_, ref) => {
    return (
        <motion.header
            ref={ref}
            className='flex justify-between items-center xl:px-4 lg:px-3 py-2 bg-white border-b border-gray-200 shadow-md'
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
        ...
        >
            <div className='space-x-2 flex items-center'>
                <Link to='/' className='flex items-center space-x-2'>
                    ...
                    <span className='text-2xl font-semibold font-serif text-[#fa541c]'>
                        Eco
                    </span>
                </Link>
            ...
            <div className='flex items-center space-x-4'>
                <Popover
                    ...
                    floatingChild={
                        <>
                            <button className='pl-2 rounded-md pr-12 py-1 hover:bg-gray-100'>
                                Hồ sơ Shop
                            </button>
                            <button className='rounded-md pr-12 py-1 hover:bg-gray-100 w-full'>
                                Đăng xuất
                            </button>
                        </>
                    }
                    floatingClassName='flex flex-col items-start border border-gray-200 rounded-sm shadow-md bg-white p-2'
                    hasArrow={true}
                ...
                <div className='flex items-center space-x-4'>
                    ...
                    <div>
                        <button className='py-1 px-3 rounded-full border border-gray-400'>
                            SHOPEE UNI
                        </button>
                    </div>
                </div>
