...
export default {
  ...
  POST<DataResponse, Body>(url: string, body: Body, config?: Omit<AxiosRequestConfig<Body>, 'params' | 'data'>) {
    return http.post<DataResponse, AxiosResponse<DataResponse>, Body>(url, body, config)
  },
  POST_WITH_FORM_DATA<DataResponse>(
    ...
    return http.post<DataResponse, AxiosResponse<DataResponse>, FormData>(url, body, {
      ...config,
      headers: {
  ...
  PUT<DataResponse, Body>(url: string, body: Body, config?: Omit<AxiosRequestConfig<Body>, 'params' | 'data'>) {
    return http.put<DataResponse, AxiosResponse<DataResponse>, Body>(url, body, config)
  },
  PUT_WITH_FORM_DATA<DataResponse>(
    ...
    return http.put<DataResponse, AxiosResponse<DataResponse>, FormData>(url, body, {
      ...config,
      headers: {
        Accept: 'application/json',
        'Content-Type': 'multipart/form-data'
